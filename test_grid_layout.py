...
from geo_temp import calculate_grid_layout
...
print("python geo_temp.py --place-list preferred --years 2024 --show none")
print("\nFor 6 places (2×3 grid):")
print("python geo_temp.py --place Austin,TX Bangalore Cambridge,UK San_Jose Trondheim Beijing --years 2024 --show none")
